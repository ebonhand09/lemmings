...
_ter_drw_tmp		RMB	1
; these are accessed externally via module-level
terrain_id		RMB	1				; Note, module was written with _ter_id being 2 bytes
terrain_drawmode	RMB	1
terrain_xpos		RMB	2
terrain_ypos		RMB	1
terrain_id		EXPORT
terrain_drawmode	EXPORT
terrain_xpos		EXPORT
terrain_ypos		EXPORT
			ENDSECTION

		SECTION	module_terrain
draw_terrain_chunk	EXPORT

;*** draw_terrain_chunk
;	Write terrain graphic data to the virtual screen
; OLD ENTRY:	a = vertical offset (in pixels)
...
!								; was __dtc_post_early_bail_3
			...
			tst	terrain_drawmode
			bne	>
			lbsr	dtc_execute_normal_mode
			rts
!								; was __dtc_post_normal_mode_check

			;** Check for upsidedown/nooverlap combined
			lda	terrain_drawmode
			...
			rts
!								; was __dtc_post_combined_upsidedown_nooverlap_mode
			...
			rts
!								; was __dtc_post_combined_upsidedown_black_mode
			...
			rts
!								; was __dtc_post_nooverlap_mode_check
			...
			lbsr	dtc_execute_upsidedown_mode
			rts
!								; was __dtc_post_upsidedown_mode_check
			...
			rts
!								; was __dtc_post_black_mode_check
...
__dtc_offset_modes
			...
			rts
!								; was __dtc_post_offset_normal_mode_check
			...
			rts
!								; was __dtc_post_offset_combined_upsidedown_nooverlap_mode
			...
			rts
!								; was __dtc_post_offset_combined_upsidedown_black_mode
			...
			rts
!								; was __dtc_post_offset_nooverlap_mode_check
			...
			lbsr	dtc_execute_offset_upsidedown_mode
			rts
!								; was __dtc_post_offset_upsidedown_mode_check
			...
			rts
!								; was __dtc_post_offset_black_mode_check
...
__dtc_exnorm_new_row
			...
			lda	terrain_ypos		; y pos to draw at
			lbsr	get_addr_start_of_line	; convert a into d and remap

			ldx	terrain_xpos		; get x offset
...
__dtc_exnorm_dl_0
			...
			inc	terrain_ypos		; point at next line	
...
dtc_get_terrain_data
			pshs	d,x
			ldb	terrain_id		; a = 0, b = terrain id
			clra
...
dtc_adjust_top_crop
			...
			clr	terrain_ypos		; reset to drawing at zero
!
			puls	a
			rts
...
dtc_adjust_pixels_to_bytes
			...
			ldd	terrain_xpos		; get the x loc in pixels
			asra				; divide by two and..
			rorb				; .. capture the remainder
			bcc	>			; remainder? brif not
			dec	_ter_drw_x_pixel_offset	; if remainder, set flag
!
			std	terrain_xpos		; store shifted value
